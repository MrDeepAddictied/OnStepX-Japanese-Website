...
#define L_HOME_PARK_TITLE "ホームポジションとパーク"
...
#define L_HINT_FOC_SEL "フォーカサー選択"
...
#define L_TRK_FULL "全軸追尾"
#define L_TRK_REFR "屈折のみ補正"
#define L_TRK_DUAL "2軸追尾"
#define L_TRK_SINGLE "1軸追尾"
...
#define L_AXPN_MICROSTEPS_GOTO "マイクロステップ(Goto時)" // "$9"
#define L_AXPN_DECAY_MODE "Decayモード"           // "$10"
#define L_AXPN_DECAY_MODE_GOTO "Decayモード(Goto時)" // "$11"
#define L_AXPN_CURRENT_HOLD "電流(mA) 保持"            // "$12"
#define L_AXPN_CURRENT_RUN "電流(mA) 駆動"              // "$13"
#define L_AXPN_CURRENT_GOTO "電流(mA) Goto"            // "$14"
